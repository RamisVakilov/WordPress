...
<div class="mainslider glide">
            <div class="glide__track" data-glide-el="track">
                ...
                $posts = get_posts( array(
                    'numberposts' => -1, //вывожу все слайдеры, но можно указать число которое я буду выводить
                ...
                foreach( $posts as $post ){
                    ...
                    ?>
                        ...
                        <li style="background-image: url('<?php the_field('slider_img',$id); ?>')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    <h2 style="
                                            <?php
                                                $field = get_field('slider_color',$id);
                                                if ($field == 'white'){
                                                    ?>
                                                        color:#fff;
                                                    <?php   
                                        ...
                                        <?php the_title(); ?>
                                            ...
                                            <?php
                                                $field = get_field('slider_btn',$id);
                                                if ($field == 'on'){
                                                    ?>
                                                      <a href="<?php the_field('slider_link',$id)?>" class="button">Узнать больше</a>
                                                    <?php   
                                                }
                                            ?>
                                 </div>
