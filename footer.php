                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('link_inst',9); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_face',9); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_youtobe',9); ?>" class="footer__social-item">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                <img src="<?php echo get_template_directory_uri() . '/asset/img/icons/svg/phone.svg'; ?>" alt="телефон" class="footer__contacts-logo">
                                <div class="footer__contacts-tel">
                                    <a href="<?php the_field('phone_1',9);?>"><?php the_field('phone_1',9);?></a>
...
<?php wp_footer(); ?>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBbTusGIvz8V9EsxE4J5RSCHwknYN9lrYI"></script> 
